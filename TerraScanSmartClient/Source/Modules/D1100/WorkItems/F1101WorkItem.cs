//--------------------------------------------------------------------------------------------
// <copyright file="F1101WorkItem.cs" company="Congruent">
//		Copyright (c) Congruent Info-Tech.  All rights reserved.
// </copyright>
// <summary>
//	This file contains methods for the F1101WorkItem.
// </summary>
//----------------------------------------------------------------------------------------------
// Change History
//**********************************************************************************
...
namespace D1100
{
    ...
    /// F1101WorkItem
    /// </summary>
    public class F1101WorkItem : WorkItem
    {
        /// <summary>
        ...
        public ExciseTaxRateData GetExciseTaxRate(int exciseRateId)
        {
            return WSHelper.GetExciseTaxRate(exciseRateId);
        }
        ...
        /// </summary>
        /// <returns>returns dataset contains Excise Tax Rate Details</returns>
        public ExciseTaxRateData ListExciseTaxRate()
        {
            return WSHelper.ListExciseTaxRate();
        }
        ...
        {
            WSHelper.SaveExciseTaxRate(exciseRateId, exciseTaxDetails, userId);
        }
        ...
        public ExciseTaxRateData GetDistrictName(int districtId)
        {
            return WSHelper.GetDistrictName(districtId);
        }
        ...
        {
            return WSHelper.DeleteExciseTaxRate(exciseRateId, userId);
        }
