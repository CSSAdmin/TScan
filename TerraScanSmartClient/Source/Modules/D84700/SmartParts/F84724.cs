//--------------------------------------------------------------------------------------------
// <copyright file="F84724.cs" company="Congruent">
//		Copyright (c) Congruent Info-Tech.  All rights reserved.
// </copyright>
// <summary>
//	This file contains methods for the F84724.
// </summary>
//----------------------------------------------------------------------------------------------
// Change History
//**********************************************************************************
...
namespace D84700
{
    ...
    /// F84724 Class file
    /// </summary>
    public partial class F84724 : BaseSmartPart
    {
        #region Variables
        ...
        /// controller F84724
        /// </summary>
        private F84724Controller form84724Control;
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="T:F84724"/> class.
        /// </summary>
        public F84724()
        {
        ...
        public F84724(int masterform, int formNo, int keyID, int red, int green, int blue, string tabText, bool permissionEdit)
        {
            this.InitializeComponent();
            this.Tag = formNo;
            ...
            this.WaterHydrantPictureBox.Image = ExtendedGraphics.GenerateVerticalImage(157, 42, tabText, red, green, blue);
        }
        ...
        public F84724(int masterform, int formNo, int keyID, int red, int green, int blue, string tabText, bool permissionEdit, int featureClassId)
        {
            this.InitializeComponent();
            this.masterFormNo = masterform;
            this.Tag = formNo;
        ...
        /// <summary>
        /// For form84724Control
        /// </summary>
        [CreateNew]
        public F84724Controller Form84724Control
        {
            get { return this.form84724Control as F84724Controller; }
            set { this.form84724Control = value; }
        }
        ...
        public void OnD9030_F9030_EnableNewMethod(object sender, EventArgs eventArgs)
        {
            try
            {
                if (this.PermissionFiled.newPermission)
                {
                    ...
                    this.ClearWaterHydrantLocationControls();
        ...
        public void OnD9030_F9030_CancelSliceInformation(object sender, EventArgs eventArgs)
        {
            try
            {
                ...
                this.LockControls(true);
                this.CustomizeWaterHydrantLocation();
        ...
        /// <summary>
        /// To Clear Water Hydrant Location Properties TextBoxs and Checked Boxs 
        /// </summary>
        private void ClearWaterHydrantLocationControls()
        {
        ...
        /// <summary>
        /// To Clear the entire Water Hydrant Form
        /// </summary>
        private void ClearWaterHydrant()
        {
        ...
        private void CreateTempListGDocPropertyReference(string refFieldValue)
        {
            ...
            this.gdocCommonData = this.form84724Control.WorkItem.F8000_GetGDocPropertyReference(this.featureClassId, refFieldValue);
        ...
        private void ToLoadAllStreetComboBox()
        {
            ...
            this.gdocCommonData = this.form84724Control.WorkItem.wListStreets();
        ...
        private void LoadGPSByComboBox()
        {
            ...
            this.gdocCommonData = this.form84724Control.WorkItem.F8000_GetGDocUser();
        ...
        /// <summary>
        /// To Load the water Pipe Location form Slice
        /// </summary>
        ...
        /// </summary>
        private void SaveWaterHydrantLocation()
        {
            ...
            /*Added By Ramya For fixing int16 issue */

            F84722WaterValveLocationData waterValveLocationInt32Data = new F84722WaterValveLocationData();
            F84722WaterValveLocationData.ListWaterValveLocationRow dr = waterValveLocationInt32Data.ListWaterValveLocation.NewListWaterValveLocationRow();

            /* Till here */
            ////this.waterValveLocationData.ListWaterValveLocation.Rows.Clear();
            ////F84722WaterValveLocationData.ListWaterValveLocationRow dr = this.waterValveLocationData.ListWaterValveLocation.NewListWaterValveLocationRow();
            ...
            waterValveLocationInt32Data.ListWaterValveLocation.Rows.Add(dr);
            tempWaterValveLocation = Utility.GetXmlString(waterValveLocationInt32Data.ListWaterValveLocation.Copy());
            this.hydrantId = this.form84724Control.WorkItem.F84722_SaveWaterValveLocation(this.hydrantId, tempWaterValveLocation, this.formNo);
            ...
            currentKeyIdInfo.SelectedKeyId = this.hydrantId;
        ...
        /// </summary>
        private void CustomizeWaterHydrantLocation()
        {
            string dateFormat = SharedFunctions.GetResourceString("GDocWaterDateFormat");
            this.waterValveLocationData = this.form84724Control.WorkItem.F84722_GetWaterValveLocation(this.hydrantId, this.formNo);
            if (this.waterValveLocationData.ListWaterValveLocation.Rows.Count > 0)
            {
        ...
        private void WaterValveLocationPictureBox_MouseEnter(object sender, EventArgs e)
        {
            try
            {
                this.GDocWaterHydrantLocationToolTip.SetToolTip(this.WaterHydrantPictureBox, Utility.GetFormNameSpace(this.Name));
            }
            catch (Exception ex)
            {
                ExceptionManager.ManageException(ex, ExceptionManager.ActionType.CloseCurrentForm, this.ParentForm);
        ...
        private void GPSTimePicker_CloseUp(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    this.GPSDateTextBox.Text = this.GPSTimePicker.Text;
        ...
        private void GPSDatePict_Click(object sender, EventArgs e)
        {
            try
            {
                if (!string.IsNullOrEmpty(this.GPSDateTextBox.Text.Trim()))
                {
                    this.GPSTimePicker.Value = Convert.ToDateTime(this.GPSDateTextBox.Text);
                }
                else
                {
                    this.GPSTimePicker.Value = DateTime.Today;
                }

                this.GPSTimePicker.Focus();
                SendKeys.Send("{F4}");
            }
            catch (Exception ex)
            {
        ...
        /// <summary>
        /// Handles the Load event of the F84724 control.
        /// </summary>
        /// <param name="sender">The source of the event.</param>
        /// <param name="e">The <see cref="T:System.EventArgs"/> instance containing the event data.</param>
        private void F84724_Load(object sender, EventArgs e)
        {
            try
            {
