// -------------------------------------------------------------------------------------------
// <copyright file="F84724WorkItem.cs" company="Congruent">
//     Copyright (c) Congruent Infotech.  All rights reserved.
// </copyright>
// <summary>This files provides the various methods to access and Update F84724</summary>
// Release history
//**********************************************************************************
...
namespace D84700
{
    ...
    /// <summary>
    /// F84724WorkItem class file
    /// </summary>
    public class F84724WorkItem : WorkItem
    {
        ...
        {
            return WSHelper.F84722_SaveWaterValveLocation(keyId, waterValveLocation, formId, TerraScan.Common.TerraScanCommon.UserId);
        }
