...
namespace D22006
{
    ...
    public class F27007WorkItem: WorkItem
    {
        ...
        /// <summary>
        /// Gets the details of F27007 Parcelheaderslimdetails
        /// </summary>
        /// <param name="eventId">Parcel id</param>
        /// <returns>Typed Dataset</returns>
        public F27007ParcelHeaderSlimData F27007_GetParcelHeaderSlimDetails(int parcelId)
        {
            return WSHelper.F27007_GetParcelHeaderSlimDetails(parcelId);
        }
        /// <summary>
