...
namespace D90010
{
    ...
    /// </summary>
    [ComVisible(true)]
    public partial class F95012 : BaseSmartPart
    {
        #region Variable
        ...
        /// controller F95005
        /// </summary>
        private F95012Controller form95012Control;
        ...
        public static bool IsQuickFindFlag = false; 
        ...
        public F95012(int masterform, int formNo, int keyID, int red, int green, int blue, string tabText, bool permissionEdit)
        {
            InitializeComponent();
        ...
        /// </summary>
        [CreateNew]
        public F95012Controller Form95012Control
        {
            get { return this.form95012Control as F95012Controller; }
            set { this.form95012Control = value; }
        }
            ...
            try
            {
                if (this.currentMasterFormNo == eventArgs.Data.MasterFormNo)
                {
                    ...
                    //{
                        ...
                        datasetf95010GetWebFormXMLData = this.form95012Control.WorkItem.GetWebFormXML(this.keyId, this.currentFormNo, TerraScanCommon.UserId);
        ...
        private void F95012_Load(object sender, EventArgs e)
        {
            try
            {
                this.flagFormLoad = true;
        ...
        private void SetFormHeight()
        {
            if (this.formHeight > 0)
            {
                ...
                this.WebSliceWebBrowser.Size = new System.Drawing.Size(766, this.formHeight);
        ...
        /// <param name="sender">The source of the event.</param>
        /// <param name="e">The <see cref="T:System.EventArgs"/> instance containing the event data.</param>
        private void F95012_Resize(object sender, EventArgs e)
        {
