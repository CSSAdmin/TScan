//--------------------------------------------------------------------------------------------
// <copyright file="MortgageImportFields.cs" company="Congruent">
...
namespace D1010
{
    ...
    /// <summary>
    /// static class containing available mortgage import fields
    /// </summary>
    public class MortgageImportFields
    {
        /// <summary>
        /// Import Id
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the FirstHalf PayCode.
        /// </summary>
        /// <value>The pay code.</value>
        public int FirstHalfPayCode
        {
            get { return this.firsthalfpaycode; }
            set { this.firsthalfpaycode = value; }
        }
