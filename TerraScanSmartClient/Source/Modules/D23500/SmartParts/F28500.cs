//--------------------------------------------------------------------------------------------
// <copyright file="F23500.cs" company="Congruent">
//		Copyright (c) Congruent Info-Tech.  All rights reserved.
// </copyright>
// <summary>
//	This file contains methods for the Snapshot Import Template.
// </summary>
//----------------------------------------------------------------------------------------------
// History
//**********************************************************************************
...
namespace D23500
{
    ...
    [SmartPart]
    public partial class F28500 : BaseSmartPart
    {
        ...
        /// controller F28500
        /// </summary>
        private F28500Controller form28500Control;
        ...
        /// <summary>
        /// SnapshotTemplateDataSet variable is used to store  for MAD Import Template. 
        /// </summary>       
        private F23500SnapshotTemplate SnapshotTemplateDataSet;
        ...
        /// Initializes a new instance of the <see cref="T:SnapshotImportTemplateForm"/> class.
        /// </summary>
        public F28500(int masterform, int formNo, int keyID, int red, int green, int blue, string tabText, bool permissionEdit)
        {
            this.InitializeComponent();
            this.masterFormNo = masterform;
            this.TemplateID = keyID;
            this.SnapshotTemplateDataSet = new F23500SnapshotTemplate();
            ...
            this.InputFileDetailPictureBox.Image = ExtendedGraphics.GenerateVerticalImage(50, 36, "", 174, 150, 94);
        ...
        /// <summary>
        /// Handles the Load event of the SnapshotImportTemplateForm control.
        /// </summary>
        /// <param name="sender">The source of the event.</param>
        /// <param name="e">The <see cref="T:System.EventArgs"/> instance containing the event data.</param>
        private void F28500_Load(object sender, EventArgs e)
        {
            ...
            if (this.ImportTypeComboBox.SelectedValue != null)
            {
                if (this.InputFileGridView.Columns.Count >= 2)
                {
                    if (this.ImportTypeComboBox.SelectedValue.ToString() == "1")
                    {
                        ...
                        this.SnapshotTemplateControlPanel.Width = 480;
                    ...
                    else if (this.ImportTypeComboBox.SelectedValue.ToString() == "2")
                    {
                        ...
                        this.SnapshotTemplateControlPanel.Width = 315;
        ...
        /// </summary>
        [CreateNew]
        public F28500Controller Form28500Control
        {
            get { return this.form28500Control as F28500Controller; }
            set { this.form28500Control = value; }
        }
        ...
        public void OnD9030_F9030_SetSlicePermission(object sender, DataEventArgs<SlicePermissionReload> eventArgs)
        {
            try
            {
                if (this.masterFormNo == eventArgs.Data.MasterFormNo)
                {
                    ...
                    if (this.SnapshotTemplateDataSet.GetSnapshotImportTemplate.Rows.Count > 0)
                    {
        ...
        {
            this.ClearControls();
            this.GetSnapshotImportTemplateDetails(Convert.ToInt32(this.TemplateID));
            this.pageMode = TerraScanCommon.PageModeTypes.View;
        }
        ...
        public void OnD9030_F9030_DeleteSliceInformation(object sender, DataEventArgs<int> eventArgs)
        {
            ...
            if (this != null && this.IsDisposed != true)
            {
                ...
                {
                    string ReturnMessage = this.form28500Control.WorkItem.DeleteSnapshotTemplate(Convert.ToInt32(this.TemplateID), TerraScanCommon.UserId);
                    if (!string.IsNullOrEmpty(ReturnMessage))
                    {
                        MessageBox.Show(ReturnMessage, "TerraScan – Snapshot Import Template in use", MessageBoxButtons.OK, MessageBoxIcon.Warning);
        ...
        public void OnD9030_F9030_SaveConfirmed(object sender, EventArgs eventArgs)
        {
            try
            {
                if ((this.pageMode == TerraScanCommon.PageModeTypes.Edit && this.slicePermissionField.editPermission) || (this.pageMode == TerraScanCommon.PageModeTypes.New && this.slicePermissionField.newPermission))
                {
                    ...
                    this.SavesnapshotImportTemplate();
                    this.pageMode = TerraScanCommon.PageModeTypes.View;
                    this.Cursor = Cursors.Default;
                }
                else
        ...
        private void LoadDefaultView()
        {
            this.EnableControls(true);
            this.EnablePanelControl(true);
            this.GetSnapshotImportFileType();
            this.F23500LoadFormDetails();
        }
        ...
        private void EnableControls(bool show)
        {
            ...
            this.SnapshotTemplateControlPanel.Enabled = show;
        ...
        private void EnablePanelControl(bool view)
        {
            ...
            this.SnapshotTemplateControlPanel.Enabled = view;
        }
        ...
        /// </summary>
        /// 
        private void F23500LoadFormDetails()
        {
            try
            {
                this.SnapshotTemplateDataSet = form28500Control.WorkItem.GetSnapshotImportTemplate(Convert.ToInt32(this.TemplateID));
                if (SnapshotTemplateDataSet.Tables[2].Rows.Count > 0)
                {
                    this.DescriptionTextBox.Text = this.SnapshotTemplateDataSet.Tables[2].Rows[0]["Description"].ToString();
                    this.TemplateNameTextBox.Text = this.SnapshotTemplateDataSet.Tables[2].Rows[0]["TemplateName"].ToString();
                    this.FilePathTextBox.Text = this.SnapshotTemplateDataSet.Tables[2].Rows[0]["FilePath"].ToString();
                    if (!string.IsNullOrEmpty(this.SnapshotTemplateDataSet.Tables[2].Rows[0]["TypeID"].ToString()))
                    {
                        this.ImportTypeComboBox.SelectedValue = this.SnapshotTemplateDataSet.Tables[2].Rows[0]["TypeID"].ToString();
                        this.form28500Control.WorkItem.RootWorkItem.State["TypeID"] = this.ImportTypeComboBox.SelectedValue.ToString();
                    }
                    this.DisplayInputFileDetails(this.SnapshotTemplateDataSet.GetSnapshotImportTemplate);
                }
                else
                {
                    this.ClearControls();
        ...
        /// <summary>
        /// Gets the snaphot import template details.
        /// </summary>
        /// <param name="templateId">The template id.</param>
        private void GetSnapshotImportTemplateDetails(int templateId)
        {
            try
            {
                if (this.SnapshotTemplateDataSet.GetSnapshotImportTemplate != null)
                {
                    if (this.SnapshotTemplateDataSet.GetSnapshotImportTemplate.Rows.Count == 0)
                    {
                        this.SnapshotTemplateDataSet = form28500Control.WorkItem.GetSnapshotImportTemplate(Convert.ToInt32(templateId));
                    }
                }
            }
            ...
            try
            {
                if (this.SnapshotTemplateDataSet.GetSnapshotImportTemplate != null)
                {
                    if (this.SnapshotTemplateDataSet.GetSnapshotImportTemplate.Rows.Count > 0)
                    {
                        ...
                        this.DescriptionTextBox.Text = this.SnapshotTemplateDataSet.GetSnapshotImportTemplate.Rows[0][this.SnapshotTemplateDataSet.GetSnapshotImportTemplate.DescriptionColumn].ToString();
                        this.FilePathTextBox.Text = this.SnapshotTemplateDataSet.GetSnapshotImportTemplate.Rows[0][this.SnapshotTemplateDataSet.GetSnapshotImportTemplate.FilePathColumn].ToString();
                        this.TemplateNameTextBox.Text = this.SnapshotTemplateDataSet.GetSnapshotImportTemplate.Rows[0][this.SnapshotTemplateDataSet.GetSnapshotImportTemplate.TemplateNameColumn].ToString();
                        this.ImportTypeComboBox.SelectedValue = this.SnapshotTemplateDataSet.GetSnapshotImportTemplate.Rows[0][this.SnapshotTemplateDataSet.GetSnapshotImportTemplate.TypeIDColumn].ToString();
                        this.DisplayInputFileDetails(this.SnapshotTemplateDataSet.GetSnapshotImportTemplate);
                    }
                    else
                    {
        ...
        private void LockControls(bool enableValue)
        {
            ...
            this.SnapshotTemplateControlPanel.Enabled = enableValue;
        }
        ...
        /// <summary>
        /// Gets the type of the Snapshot import file.
        /// </summary>
        private void GetSnapshotImportFileType()
        {
            try
            {
                F23500SnapshotTemplate SnapshotImportFileTypeDataSet = this.form28500Control.WorkItem.ListSnapshotImportFileType();
                this.ImportTypeComboBox.ValueMember = "TypeID";
                this.ImportTypeComboBox.DisplayMember = "TypeName";
                this.ImportTypeComboBox.DataSource = SnapshotImportFileTypeDataSet.ListSnapshotImportFileType;
            }
            catch (SoapException ex)
            {
                ExceptionManager.ManageException(ex, ExceptionManager.ActionType.CloseCurrentForm, this.ParentForm);
        ...
        /// </summary>
        /// <param name="snapshotDatatable">The snapshot datatable.</param>
        private void DisplayInputFileDetails(F23500SnapshotTemplate.GetSnapshotImportTemplateDataTable snapshotImportDatatable)
        {
            try
            {
                if (snapshotImportDatatable != null)
                {
                    if (snapshotImportDatatable.Rows.Count > 0)
                    {
                        this.inputFileDataTable.Rows[0][1] = snapshotImportDatatable.Rows[0][snapshotImportDatatable.ParcelNumber_PosColumn].ToString();
                        this.inputFileDataTable.Rows[0][2] = snapshotImportDatatable.Rows[0][snapshotImportDatatable.ParcelNumber_WidColumn].ToString();
                    }
                    else
                    {
        ...
        /// <summary>
        /// Saves the snapshot import.
        /// </summary>
        /// <returns>SavesnapshotImportTemplate</returns>
        /// 
        private bool SavesnapshotImportTemplate()
        {
            try
            {
                if ((this.pageMode == TerraScanCommon.PageModeTypes.Edit && this.slicePermissionField.editPermission) || (this.pageMode == TerraScanCommon.PageModeTypes.New && this.slicePermissionField.newPermission))
                {
                    ...
                    F23500SnapshotTemplate insertsnapshotimportDetails = new F23500SnapshotTemplate();
                    F23500SnapshotTemplate.SaveSnapshotImportTemplateRow dr = insertsnapshotimportDetails.SaveSnapshotImportTemplate.NewSaveSnapshotImportTemplateRow();
                    ...
                    insertsnapshotimportDetails.SaveSnapshotImportTemplate.Rows.Add(dr);
                    insertsnapshotimportDetails.SaveSnapshotImportTemplate.AcceptChanges();
                    DataSet tempDataSet = new DataSet("Root");
                    tempDataSet.Tables.Add(insertsnapshotimportDetails.SaveSnapshotImportTemplate.Copy());
                    tempDataSet.Tables[0].TableName = "Table";
                    int returnValue;
                    returnValue = this.form28500Control.WorkItem.SaveSnapshotImportTemplate(TemplateID, tempDataSet.GetXml(), TerraScanCommon.UserId);
                    SliceReloadActiveRecord sliceUpdateActiveRecord = new SliceReloadActiveRecord();
                    sliceUpdateActiveRecord.MasterFormNo = this.masterFormNo;
        ...
        /// <param name="sender">The source of the event.</param>
        /// <param name="e">The <see cref="T:System.EventArgs"/> instance containing the event data.</param>
        private void F23500_Enter(object sender, EventArgs e)
        {
        ...
        private void ImportViewButton_Click(object sender, EventArgs e)
        {
            ...
            {
                FormInfo formInfo;
                formInfo = TerraScanCommon.GetFormInfo(23510);
